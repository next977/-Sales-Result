		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#SYNCzdcsdui5vbr-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SYNCzdcsdui5vbr-display": {
								"semanticObject": "SYNCzdcsdui5vbr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=SYNC.zdcsdui5vbr",
									"url": sap.ui.require.toUrl("SYNC/zdcsdui5vbr")
								}
							}
						}
					}
